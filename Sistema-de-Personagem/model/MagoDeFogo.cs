...
{
    public class MagoDeFogo : Personagem
    {
        private string genero;
        private string especial;

        public MagoDeFogo(int vida, int ataque, int defesa, int velocidade, string genero, string especial) : base (vida, ataque, defesa, velocidade)
        {
            this.genero = genero;
