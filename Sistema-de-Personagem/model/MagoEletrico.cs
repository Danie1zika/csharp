...
{
    public class MagoEletrico : Personagem
    {
        private string genero;
        private string especial;

        public MagoEletrico(int vida, int ataque, int defesa, int velocidade, string genero, string especial) : base (vida, ataque, defesa, velocidade)
        {
            this.genero = genero;
